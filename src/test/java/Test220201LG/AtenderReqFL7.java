...
public class AtenderReqFL7 {
    ...
    @Test
    public void AtenderReqFL7() throws InterruptedException {
//Inicia la pagina.
...
//Login con firma.
        ...
        WebElement btnSig1 = driver.findElement(By.xpath("//*[@id=\"requerimientoSolicitud\"]/div[2]/div/input"));
        btnSig1.click();

        WebElement btnSig2 = driver.findElement(By.xpath("//*[@id=\"acciones\"]/input[1]"));
        btnSig2.click();

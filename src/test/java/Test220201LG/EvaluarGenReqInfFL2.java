...
public class EvaluarGenReqInfFL2 {
    ...
    @Test
    public void EvaluarGenReqInfFL2() throws InterruptedException {
...
//Login con firma.
        ...
        //GUARDAR Y FIRMAR
        WebElement btnGuardFirm = driver.findElement(By.xpath("//*[@id=\"mostrarFirmaId\"]"));
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
        btnGuardFirm.click();
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);

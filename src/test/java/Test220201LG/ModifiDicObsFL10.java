...
public class ModifiDicObsFL10 {
    ...
    @Test
    public void ModifiDicObsFL10() throws InterruptedException {
...
//Login con firma.
        ...
        WebElement btnModf = driver.findElement(By.xpath("/html/body/main/div/div[4]/div/form/div[2]/span/input"));
        btnModf.click();
        ...
        //BTN SIG
        WebElement btnSig = driver.findElement(By.name("mostrarSiguiente"));
        btnSig.click();
